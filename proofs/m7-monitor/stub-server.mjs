// Minimal stateful stub of the internal work-tracking API (self-contained copy of the
// M1 stub) so this proof re-runs without depending on a sibling proof dir. Requires an
// auth header and logs each request.
